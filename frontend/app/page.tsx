...
function formatTimestamp(value: string) {
  ...
  // Avoid locale/timezone-dependent formatting that can cause Next.js hydration mismatch.
  // `datetime-local` values already come in a stable `YYYY-MM-DDTHH:MM` shape.
...
function mapGenerateReportToUiReport(payload: ApiGenerateReportResponse): ReportState {
  return {
    ...
    impact: {
      services: [],
      downtime: payload.impact || "Unknown",
      severity: "Unknown"
    },
    postmortem: {
